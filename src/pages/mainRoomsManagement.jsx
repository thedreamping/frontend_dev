  ...
  return (
    <>
      <div className="workspace">
        <div className="title">메인 ROOMS 배너 관리</div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" placeholder="객실 그룹 이름" />
                  <br />
                  <br />
                  <input type="text" placeholder="문구" />
                  <br />
                  <br />
...
export default MainRoomsManagement;
